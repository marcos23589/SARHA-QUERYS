...
df_resultados = df_resultados.assign(
    COD_SUBCONCEPTO="1",
    FECHA_DESDE="12/1/2024",
    PERIODO_DESDE="202412",
    REINTEGRO="8",
    FECHA_HASTA="31/12/2024",
    CANTIDAD="1",
    ID_TRANSACCION="210958",
    FECHA_TRANSACCION="13/12/2024",
    COD_TIPO_UNIDAD="5",
    COD_UNIDAD="1",
    COD_USUARIO="3633",
    COD_CONVENIO="1",
    OBSERVACION="GCIAS SAC2",
    GENERADO_HABERES="1",
...
# Eliminar filas donde CUIL sea igual a 0
df_resultados = df_resultados[df_resultados['CUIL'] != 0]

# Formatear la columna 'IMPORTE_GEN_HAB' para mostrar 2 decimales
df_resultados["IMPORTE_GEN_HAB"] = pd.to_numeric(
    df_resultados["IMPORTE_GEN_HAB"], errors="coerce"
).round(2)
