...
try:
   ...
   AND BRU.BRUTO_MIGRADO IS NOT NULL
   --AND CL.VALOR <> 0
                                                            --<<<<PARA QUE TRAIGA A LOS QUE SE LES CALCULA ALGO DE IMPUESTO A LAS GANANCIAS   
   ...
   ,WEB.FECHA_PRESENTACION_AFIP desc
    ...
    df_vertical.to_excel(f"S:\LDDAT\GANANCIAS\COBOL-{numero_liquidacion}-908.xlsx", index=False)
