...
try:
   ...
   embargos_sql = f"""SELECT 
    ...
    sum(case when cl.cod_concepto = 327 then cl.valor else 0 end) as RETENCION_GCIAS
...
""";
   ...
   df_vertical.to_excel(f'./SALIDA/GANANCIAS-{numero_liquidacion}.xlsx', index=False)
