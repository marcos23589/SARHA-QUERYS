...
try:
   ...
   AND WEB.FECHA_PRESENTACION_AFIP >= TO_DATE('18/09/2024 00:00:00', 'DD/MM/YYYY HH24:MI:SS') --<<<< SI SE QUIERE SABER LAS PRESENTACIONES DE SIRADIG REALIZADAS DESDE --CIERTO DIA
   ORDER BY 
   ...
   ,WEB.FECHA_PRESENTACION_AFIP desc
    ...
    df_vertical.to_excel(
        f"./SALIDA/COBOL-SIRADIG-F572-{numero_liquidacion}-952-NEGATIVO.xlsx",
        index=False,
    )
