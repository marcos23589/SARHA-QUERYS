...
try:
   ...
   AND WEB.FECHA_PRESENTACION_AFIP >= TO_DATE('11/10/2024 00:00:00', 'DD/MM/YYYY HH24:MI:SS') --<<<< SI SE QUIERE SABER LAS PRESENTACIONES DE SIRADIG REALIZADAS DESDE --CIERTO DIA
   ORDER BY 
